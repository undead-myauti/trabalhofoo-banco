public class Diretor extends Funcionario {
    ...
    public Diretor(double saldo, String name, int tipoConta){
        super(saldo, name);
    ...
    public String saque(double valor){
        if(this.tipoConta == 1){
            System.out.println("Para esse tipo de conta, temos uma taxa de 5% no saque");
            valor += valor * 0.5;
            if(valor > this.saldo){
            ...
            System.out.println("Para esse tipo de conta, temos uma taxa de 2% no saque");
            valor += valor * 0.2;
            if(valor > this.saldo){
                return "O valor de saque é maior que o saldo";
            }
